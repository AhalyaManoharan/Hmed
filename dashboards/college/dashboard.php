...
if (!isset($_SESSION['user_id']) || $_SESSION['user_type'] !== 'college') {
  header("Location: ../../login/login.php?role=college");
  exit;
}
?>
...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Jun 2025 15:24:39 GMT -->
</html>
