      ...
      <div class="row">
        <div class="col-xl-12">
          ...
          <div class="utf-categories-container-block"> 
            <a href="jobs-list-layout-leftside.html" class="utf-category-box-two">
				<div class="utf-opening-position-counter-item-two">10 Openings</div>
				<div class="utf-category-box-icon-item"> <i class="icon-line-awesome-bullhorn"></i> </div>
				<div class="utf-category-box-content-two">
				  <h3>Design, Art & Multimedia</h3>
				</div>
				<div class="utf-category-box-counter-item-two">8,188 Jobs</div>
            </a> 
            ...
            <a href="jobs-list-layout-leftside.html" class="utf-category-box-two">
				<div class="utf-opening-position-counter-item-two">12 Openings</div>
				<div class="utf-category-box-icon-item"> <i class="icon-line-awesome-line-chart"></i> </div>
				<div class="utf-category-box-content-two">
				  <h3>Accounting / Finance</h3>
				</div>
				<div class="utf-category-box-counter-item-two">6,258 Jobs</div>
            </a> 
            <a href="jobs-list-layout-leftside.html" class="utf-category-box">
            ...
            <a href="jobs-list-layout-leftside.html" class="utf-category-box-two">
				<div class="utf-opening-position-counter-item-two">18 Openings</div>
				<div class="utf-category-box-icon-item"> <i class="icon-line-awesome-cutlery"></i> </div>
				<div class="utf-category-box-content-two">
				  <h3>Restaurant / Food Service</h3>
				</div>
				<div class="utf-category-box-counter-item-two">5,138 Jobs</div>
            </a> 
            <a href="jobs-list-layout-leftside.html" class="utf-category-box">
            ...
            <a href="jobs-list-layout-leftside.html" class="utf-category-box-two">
				<div class="utf-opening-position-counter-item-two">23 Openings</div>
				<div class="utf-category-box-icon-item"> <i class="icon-line-awesome-user-md"></i> </div>
				<div class="utf-category-box-content-two">
				  <h3>Health</h3>
				</div>
				<div class="utf-category-box-counter-item-two">2,360 Jobs</div>
            </a> 
		  </div>
...
function timeAgo(date) {
  ...
  <!-- Photo Section -->
	<div class="utf-photo-section-block" data-background-image="images/section-background.jpg">
  ...
  <div id="footer"> 
        ...
        <div class="row">
		  <div class="col-xl-4 col-md-12">
			<div class="utf-footer-item-links">
				<a href="index.html"><img class="footer-logo" src="images/logo-foot.png" alt=""></a>
    ...
    <div class="utf-footer-copyright-item">
      <div class="container">
        <div class="row">
          <div class="col-xl-12">Copyright &copy; 2025 All Rights Reserved.</div>
        </div>
      </div>
    </div>
...
<!-- Mirrored from jobword.utouchdesign.com/jobword_ltr/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 16 Jun 2025 15:24:14 GMT -->
</html>